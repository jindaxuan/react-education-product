                ...
                <Row>
                    ...
                    <Col span="18">
                        <div className={css.allclass_content}>
                            ...
                            <Row>
                                <Col span="15">
                                    <span id="all" className={this.state.type===-1?css.active:''} onClick={()=>{this.search(-1)}} >全部课程</span>
                                    <span id="wait" className={this.state.type===0?css.active:''} onClick={()=>{this.search(0)}} >待付款</span>
                                    <span id="succ" className={this.state.type===1?css.active:''} onClick={()=>{this.search(1)}} >已完成</span>
                                    <span id="outs" className={this.state.type===2?css.active:''} onClick={()=>{this.search(2)}} >已关闭</span>
                                </Col>
                                <Col span="9">
